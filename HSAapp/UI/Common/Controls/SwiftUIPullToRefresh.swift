...
public struct RefreshableScrollView<Content: View>: View {
  ...
  public init(onRefresh: @escaping OnRefresh, @ViewBuilder content: () -> Content) {
    ...
    self.backgroundColor = Color.darkBackground
  }
    public init(backgroundColor: Color, onRefresh: @escaping OnRefresh, @ViewBuilder content: () -> Content) {
        self.onRefresh = onRefresh
        self.content = content()
        ...
        PositionIndicator(type: .moving)
         ...
         content
          ...
          ZStack {
            ...
            ZActivityIndicator(isAnimating: state == .loading) {
...
private struct ZActivityIndicator: UIViewRepresentable {
